 ...
 */
@Singleton
public class CampaignPage extends OAuth2EntryPage
		implements Path, CampaignSpreadsheet {

	@Inject
	public CampaignPage(HttpTransport transport, JsonFactory jsonFactory, OAuth2Utils oauth2Utils) {
		super(transport, jsonFactory, oauth2Utils);
	}

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		req.getRequestDispatcher(CAMPAIGN_PAGE_URL + "index.html").forward(req, resp);
	}
}
