 ...
 */
@Singleton
public class EventBriteAPI extends OAuth2EntryPage
		implements Path, CampaignSpreadsheet {

	private static final Logger logger = LoggerFactory.getLogger(EventBriteAPI.class);

	@Inject
	public EventBriteAPI(HttpTransport transport, JsonFactory jsonFactory, OAuth2Utils oauth2Utils) {
