 ...
 */
@Singleton
public class SendQrServlet extends OAuth2EntryServlet
		implements Path, RegisterFormResponseSpreadsheet {

	private static final Logger logger = LoggerFactory.getLogger(SendQrServlet.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		req.getRequestDispatcher("/authenticated/send-qr/index.html").forward(req, resp);
	}
